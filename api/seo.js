...
const PAGE_DEFS = {
  ...
  'baemin-discount': {
    ...
    description: '오늘 배민에서 받을 수 있는 브랜드별 쿠폰·할인을 확인하고 요기요·쿠팡이츠·땡겨요와 할인금액을 비교해보세요.',
    h1: '오늘 배민 쿠폰·할인 비교',
  ...
  'ddangyo-discount': {
    ...
    description: '오늘 땡겨요에서 확인되는 브랜드별 쿠폰·할인을 배민·요기요·쿠팡이츠와 비교해보세요.',
    h1: '오늘 땡겨요 쿠폰·할인 비교',
  ...
  'today-pizza-discount': {
    ...
    description: '주요 피자 브랜드의 오늘 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하세요.',
    h1: '오늘 피자 할인·쿠폰 비교',
  ...
  'today-burger-discount': {
    ...
    description: '맥도날드·롯데리아·버거킹·맘스터치 등 햄버거 브랜드의 오늘 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하세요.',
    h1: '오늘 햄버거 할인·쿠폰 비교',
  ...
  'bbq-discount': {
    ...
    description: '오늘 BBQ 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 BBQ 할인·쿠폰 비교',
  ...
  'bhc-discount': {
    ...
    description: '오늘 BHC 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 BHC 할인·쿠폰 비교',
  ...
  'gyochon-discount': {
    ...
    description: '오늘 교촌치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 교촌치킨 할인·쿠폰 비교',
  ...
  'gubne-discount': {
    ...
    description: '오늘 굽네치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 굽네치킨 할인·쿠폰 비교',
  ...
  'chegatjip-discount': {
    ...
    description: '오늘 처갓집양념치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 처갓집 할인·쿠폰 비교',
  ...
  'dominopizza-discount': {
    ...
    description: '오늘 도미노피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'pizzahut-discount': {
    ...
    description: '오늘 피자헛 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 피자헛 할인·쿠폰 비교',
  ...
  'lotteria-discount': {
    ...
    description: '오늘 롯데리아 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 롯데리아 할인·쿠폰 비교',
  ...
  'mcdonald-discount': {
    ...
    description: '오늘 맥도날드 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 맥도날드 할인·쿠폰 비교',
  ...
  'momstouch-discount': {
    ...
    description: '오늘 맘스터치 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 맘스터치 할인·쿠폰 비교',
  ...
  'pooradak-discount': {
    ...
    description: '오늘 푸라닭 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 푸라닭 할인·쿠폰 비교',
  ...
  'norangtongdak-discount': {
    ...
    description: '오늘 노랑통닭 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 노랑통닭 할인·쿠폰 비교',
  ...
  'hosigi-discount': {
    ...
    description: '오늘 호식이두마리치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'jadam-discount': {
    ...
    description: '오늘 자담치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 자담치킨 할인·쿠폰 비교',
  ...
  'kkuvrako-discount': {
    ...
    description: '오늘 꾸브라꼬숯불치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'nene-discount': {
    ...
    description: '오늘 네네치킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 네네치킨 할인·쿠폰 비교',
  ...
  'ttoraeorae-discount': {
    ...
    description: '오늘 또래오래 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 또래오래 할인·쿠폰 비교',
  ...
  'banolrim-discount': {
    ...
    description: '오늘 반올림피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'youthpizza-discount': {
    ...
    description: '오늘 청년피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 청년피자 할인·쿠폰 비교',
  ...
  '7st-pizza-discount': {
    ...
    description: '오늘 7번가피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'mrpizza-discount': {
    ...
    description: '오늘 미스터피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'leejaemo-discount': {
    ...
    description: '오늘 이재모피자 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'baskinrobbins-discount': {
    ...
    description: '오늘 배스킨라빈스 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'dunkin-discount': {
    ...
    description: '오늘 던킨 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 던킨 할인·쿠폰 비교',
  ...
  'touslesjours-discount': {
    ...
    description: '오늘 뚜레쥬르 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 뚜레쥬르 할인·쿠폰 비교',
  ...
  'starbucks-discount': {
    ...
    description: '오늘 스타벅스 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 스타벅스 할인·쿠폰 비교',
  ...
  'burgerking-discount': {
    ...
    description: '오늘 버거킹 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 버거킹 할인·쿠폰 비교',
  ...
  'whattheburger-discount': {
    ...
    description: '오늘 왓더버거 할인·쿠폰을 배민·요기요·쿠팡이츠·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 왓더버거 할인·쿠폰 비교',
