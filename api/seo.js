...
const PAGE_DEFS = {
  'today-delivery-discount': {
    title: '오늘 배달 할인·쿠폰 비교 | 배민·쿠팡이츠·요기요·땡겨요 - 주문의고수',
    description: '오늘 배민·쿠팡이츠·요기요·땡겨요에서 진행 중인 브랜드별 할인·쿠폰을 한눈에 비교하세요.',
    h1: '오늘 배달 할인·쿠폰 비교',
    intro: '배민·쿠팡이츠·요기요·땡겨요 4개 배달앱에서 지금 진행 중인 할인 중, 실제로 받는 금액(원 단위)이 큰 순서로 모았습니다.',
    filter: () => true,
    limit: 20,
  },
  'today-chicken-discount': {
    title: '오늘 치킨 할인·쿠폰 비교 | 배달앱별 비교 - 주문의고수',
    description: '교촌·BHC·BBQ·굽네·푸라닭 등 치킨 브랜드의 오늘 할인·쿠폰을 4개 배달앱별로 비교하세요.',
    h1: '오늘 치킨 할인·쿠폰 비교',
  ...
  'delivery-app-compare': {
    ...
    description: '4대 배달앱에서 제공되는 브랜드별 할인·쿠폰을 비교해 오늘 어느 앱의 혜택이 큰지 확인하세요.',
    h1: '배달앱 할인·쿠폰 비교',
  ...
  'baemin-discount': {
    title: '배민 쿠폰·할인 비교 | 오늘 배달의민족 할인 - 주문의고수',
    description: '오늘 배민에서 받을 수 있는 브랜드별 쿠폰·할인을 확인하고 쿠팡이츠·요기요·땡겨요와 할인금액을 비교해보세요.',
    h1: '오늘 배민 쿠폰·할인 비교',
  ...
  'coupangeats-discount': {
    title: '쿠팡이츠 쿠폰·할인 비교 | 오늘 배달 할인 - 주문의고수',
    description: '오늘 쿠팡이츠 브랜드별 쿠폰·할인을 확인하고 배민·요기요·땡겨요와 할인금액을 비교해보세요.',
    h1: '오늘 쿠팡이츠 쿠폰·할인 비교',
  ...
  'yogiyo-discount': {
    title: '요기요 쿠폰·할인 비교 | 오늘 배달 할인 - 주문의고수',
    description: '오늘 요기요에서 확인되는 브랜드별 쿠폰·할인을 배민·쿠팡이츠·땡겨요와 한눈에 비교해보세요.',
    h1: '오늘 요기요 쿠폰·할인 비교',
  ...
  'ddangyo-discount': {
    title: '땡겨요 쿠폰·할인 비교 | 오늘 배달 할인 - 주문의고수',
    description: '오늘 땡겨요에서 확인되는 브랜드별 쿠폰·할인을 배민·쿠팡이츠·요기요와 비교해보세요.',
    h1: '오늘 땡겨요 쿠폰·할인 비교',
  ...
  'chicken-app-compare': {
    title: '치킨 배달앱 할인 비교 | 배민 vs 쿠팡이츠 vs 요기요 vs 땡겨요 - 주문의고수',
    description: '치킨 브랜드를 배달앱 4곳에서 동시에 비교했습니다. 오늘 어디서 시키는 게 가장 저렴한지 확인하세요.',
    h1: '치킨 배달앱 할인 비교',
    intro: '같은 치킨 브랜드를 배민·쿠팡이츠·요기요·땡겨요에서 비교했을 때, 오늘은 어느 앱이 가장 할인이 큰지 모았습니다.',
    filter: d => (d.category || []).includes('치킨'),
    limit: 15,
    multiAppOnly: true,
  },
  ...
  'today-pizza-discount': {
    title: '오늘 피자 할인·쿠폰 비교 | 배달앱별 비교 - 주문의고수',
    description: '주요 피자 브랜드의 오늘 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하세요.',
    h1: '오늘 피자 할인·쿠폰 비교',
  ...
  'today-burger-discount': {
    ...
    description: '맥도날드·롯데리아·버거킹·맘스터치 등 햄버거 브랜드의 오늘 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하세요.',
    h1: '오늘 햄버거 할인·쿠폰 비교',
  ...
  'bbq-discount': {
    title: 'BBQ 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 BBQ 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 BBQ 할인·쿠폰 비교',
  ...
  'bhc-discount': {
    title: 'BHC 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 BHC 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 BHC 할인·쿠폰 비교',
  ...
  'gyochon-discount': {
    title: '교촌치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 교촌치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 교촌치킨 할인·쿠폰 비교',
  ...
  'gubne-discount': {
    title: '굽네치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 굽네치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 굽네치킨 할인·쿠폰 비교',
  ...
  'chegatjip-discount': {
    title: '처갓집 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 처갓집양념치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 처갓집 할인·쿠폰 비교',
  ...
  'dominopizza-discount': {
    title: '도미노피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 도미노피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 도미노피자 할인·쿠폰 비교',
  ...
  'pizzahut-discount': {
    title: '피자헛 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 피자헛 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 피자헛 할인·쿠폰 비교',
  ...
  'lotteria-discount': {
    title: '롯데리아 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 롯데리아 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 롯데리아 할인·쿠폰 비교',
  ...
  'mcdonald-discount': {
    title: '맥도날드 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 맥도날드 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 맥도날드 할인·쿠폰 비교',
  ...
  'momstouch-discount': {
    title: '맘스터치 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 맘스터치 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 맘스터치 할인·쿠폰 비교',
  ...
  'pooradak-discount': {
    title: '푸라닭 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 푸라닭 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 푸라닭 할인·쿠폰 비교',
  ...
  'norangtongdak-discount': {
    title: '노랑통닭 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 노랑통닭 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 노랑통닭 할인·쿠폰 비교',
  ...
  'hosigi-discount': {
    title: '호식이두마리치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 호식이두마리치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 호식이두마리치킨 할인·쿠폰 비교',
  ...
  'jadam-discount': {
    title: '자담치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 자담치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 자담치킨 할인·쿠폰 비교',
  ...
  'kkuvrako-discount': {
    title: '꾸브라꼬숯불치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 꾸브라꼬숯불치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 꾸브라꼬숯불치킨 할인·쿠폰 비교',
  ...
  'nene-discount': {
    title: '네네치킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 네네치킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 네네치킨 할인·쿠폰 비교',
  ...
  'ttoraeorae-discount': {
    title: '또래오래 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 또래오래 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 또래오래 할인·쿠폰 비교',
  ...
  'banolrim-discount': {
    title: '반올림피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 반올림피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 반올림피자 할인·쿠폰 비교',
  ...
  'youthpizza-discount': {
    title: '청년피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 청년피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 청년피자 할인·쿠폰 비교',
  ...
  '7st-pizza-discount': {
    title: '7번가피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 7번가피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 7번가피자 할인·쿠폰 비교',
  ...
  'mrpizza-discount': {
    title: '미스터피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 미스터피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 미스터피자 할인·쿠폰 비교',
  ...
  'leejaemo-discount': {
    title: '이재모피자 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 이재모피자 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 이재모피자 할인·쿠폰 비교',
  ...
  'baskinrobbins-discount': {
    title: '배스킨라빈스 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 배스킨라빈스 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 배스킨라빈스 할인·쿠폰 비교',
  ...
  'dunkin-discount': {
    title: '던킨 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 던킨 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 던킨 할인·쿠폰 비교',
  ...
  'touslesjours-discount': {
    title: '뚜레쥬르 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 뚜레쥬르 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 뚜레쥬르 할인·쿠폰 비교',
  ...
  'starbucks-discount': {
    title: '스타벅스 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 스타벅스 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 스타벅스 할인·쿠폰 비교',
  ...
  'myeongrang-discount': {
    ...
    description: '오늘 명랑핫도그 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
  ...
  'ddeokcham-discount': {
    ...
    description: '오늘 떡참 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 떡참 할인·쿠폰 비교',
  ...
  'burgerking-discount': {
    title: '버거킹 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 버거킹 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 버거킹 할인·쿠폰 비교',
  ...
  'whattheburger-discount': {
    title: '왓더버거 할인·쿠폰 비교 | 오늘 배달앱 할인 - 주문의고수',
    description: '오늘 왓더버거 할인·쿠폰을 배민·쿠팡이츠·요기요·땡겨요별로 비교하고 최근 할인 이력을 확인하세요.',
    h1: '오늘 왓더버거 할인·쿠폰 비교',
...
const NAV_LINKS = [
  ...
  ['today-burger-discount', '오늘 햄버거 할인·쿠폰'],
  ...
  ['bbq-discount', 'BBQ 할인·쿠폰'],
  ['bhc-discount', 'BHC 할인·쿠폰'],
  ['gyochon-discount', '교촌치킨 할인·쿠폰'],
  ['gubne-discount', '굽네치킨 할인·쿠폰'],
  ['chegatjip-discount', '처갓집 할인·쿠폰'],
  ['dominopizza-discount', '도미노피자 할인·쿠폰'],
  ['pizzahut-discount', '피자헛 할인·쿠폰'],
  ['lotteria-discount', '롯데리아 할인·쿠폰'],
  ['mcdonald-discount', '맥도날드 할인·쿠폰'],
  ['momstouch-discount', '맘스터치 할인·쿠폰'],
  ...
  ['norangtongdak-discount', '노랑통닭 할인·쿠폰'],
  ['jadam-discount', '자담치킨 할인·쿠폰'],
  ['pooradak-discount', '푸라닭 할인·쿠폰'],
  ['nene-discount', '네네치킨 할인·쿠폰'],
  ['hosigi-discount', '호식이두마리치킨 할인·쿠폰'],
  ['kkuvrako-discount', '꾸브라꼬숯불치킨 할인·쿠폰'],
  ['ttoraeorae-discount', '또래오래 할인·쿠폰'],
  ['mrpizza-discount', '미스터피자 할인·쿠폰'],
  ['banolrim-discount', '반올림피자 할인·쿠폰'],
  ['youthpizza-discount', '청년피자 할인·쿠폰'],
  ['7st-pizza-discount', '7번가피자 할인·쿠폰'],
  ['leejaemo-discount', '이재모피자 할인·쿠폰'],
  ['burgerking-discount', '버거킹 할인·쿠폰'],
  ['whattheburger-discount', '왓더버거 할인·쿠폰'],
  ['starbucks-discount', '스타벅스 할인·쿠폰'],
...
function renderStatsInsight(stats, brandLabel){
  ...
  if (!parts.length){
    return `<section style="margin:28px 0;">
      ...
      <p style="font-size:14px; line-height:1.7; color:${TEXT}; margin:0;">배달앱(배민·쿠팡이츠·요기요·땡겨요)에서 브랜드명을 검색한 뒤, 쿠폰함이나 할인 배너에서 정액 할인을 확인하고 결제 전 최종 금액을 다시 확인하세요.</p>
    </section>`;
  }
